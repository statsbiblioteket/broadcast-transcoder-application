...
parallel --sshlogin $machines --jobs $WORKERS --colsep ' '  --retries 3 --resume --joblog $SCRIPT_PATH/$id.log --eta --progress $SCRIPT_PATH/transcodeFile.sh $collection {} :::: $SCRIPT_PATH/$id
returncode=$?
